...
class WarpForecastSettings:
    ...
    monthlyShopEnabled: bool = True
    monthlyShopSpecialPass: int = 5
    monthlyShopNormalPass: int = 5
    monthlyShopCountOverride: int = -1
    previewJade: int = 300
    scanBag: bool = True
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "monthlyShop.enabled": self.monthlyShopEnabled,
            "monthlyShop.specialPass": self.monthlyShopSpecialPass,
            "monthlyShop.normalPass": self.monthlyShopNormalPass,
            "monthlyShop.countOverride": self.monthlyShopCountOverride,
    ...
    def from_dict(cls, data: dict):
        ...
        return cls(**{
            ...
            "monthlyShopEnabled": data.get("monthlyShop.enabled", True),
            "monthlyShopSpecialPass": data.get("monthlyShop.specialPass", 5),
            "monthlyShopNormalPass": data.get("monthlyShop.normalPass", 5),
            "monthlyShopCountOverride": data.get("monthlyShop.countOverride", -1),
