...
def _get_warp_forecast_setting(task: BaseTask, key: str, default: Any) -> Any:
    ...
    aliases = {
        ...
        "monthly_shop_enabled": "monthlyShopEnabled",
        "monthly_shop_special_pass": "monthlyShopSpecialPass",
        "monthly_shop_normal_pass": "monthlyShopNormalPass",
        "monthly_shop_count_override": "monthlyShopCountOverride",
