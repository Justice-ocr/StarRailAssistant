    ...
    def on_completed(self) -> None:
        ...
        if self.__class__.__name__ in on_complete:
            ...
            if hasattr(self.operator, "wait_img"):
                ...
                self.operator.click_img(IMG.COSMIC_STRIFE, after_sleep=1)
                self.operator.click_point(0.235, 0.81, after_sleep=1)
            ...
            self.send_notification(f"任务 {self.__class__.__name__} 执行完成。", "success", image)
