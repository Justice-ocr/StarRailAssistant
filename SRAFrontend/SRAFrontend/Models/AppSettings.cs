...
{
    public const string Version = "2.18.0-beta.1"; // 应用版本号
...
public partial class WarpForecastSettings : ObservableObject
{
    ...
    [ObservableProperty]
    [property: JsonPropertyName("monthlyShop.enabled")]
    [property: Description("是否计入每月 1 号商店兑换的星轨专票和星轨通票")]
    private bool _monthlyShopEnabled = true;

    [ObservableProperty]
    [property: JsonPropertyName("monthlyShop.specialPass")]
    [property: Description("每次月初商店兑换可获得的星轨专票数量，默认 5")]
    private int _monthlyShopSpecialPass = 5;

    [ObservableProperty]
    [property: JsonPropertyName("monthlyShop.normalPass")]
    [property: Description("每次月初商店兑换可获得的星轨通票数量，默认 5")]
    private int _monthlyShopNormalPass = 5;

    [ObservableProperty]
    [property: JsonPropertyName("monthlyShop.countOverride")]
    [property: Description("剩余月初商店兑换次数覆写，-1 表示按版本结束日前的每月 1 号自动计算")]
    private int _monthlyShopCountOverride = -1;
    ...
    [property: Description("是否自动扫描顶栏星琼，以及背包第一排中的星轨专票和星轨通票")]
