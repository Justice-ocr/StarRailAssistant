...
public class ScriptService
{
    private static readonly string ScriptsDir =
        Path.Combine(DataPath.AppDataDir, "scripts");
    private static readonly string ReposConfigPath =
        Path.Combine(DataPath.AppDataDir, "script_repos.json");
        ...
        IProgress<(int Percent, string Message)>? progress = null)
    {
        ...
        var scriptDir = GetScriptDir(info.Id);
        var tmpZip = Path.Combine(DataPath.AppDataDir, $"_tmp_{info.Id}.zip");
